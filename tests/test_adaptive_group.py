...
This file merges the adaptive backoff/lifecycle/EWMA tests, the
learning speed tests, and the expire-adaptive-overrides test.
"""
...
async def test_expire_adaptive_overrides(hass):
    entry = MockConfigEntry(domain=DOMAIN, data={"devices": []})
    entry.add_to_hass(hass)
